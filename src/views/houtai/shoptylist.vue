  ...
  <div id="shoptylist">
    <el-form label-width="100px">
      <el-form-item label="类型名:">
        ...
        <el-button type="primary" plain @click="queryrole()" style="width: 100px">查询</el-button>
        <el-button type="primary" plain @click="addshop()"  style="width: 100px;margin-left: 260px">添加</el-button>
      </el-form-item>
