          ...
          <div style="background: white;width: 521px;height: 440px">
            <el-col>
              <div style="margin-top: 20px;margin-left: 20px">
                ...
                <a class="a-color" style="font-size: 15px">交货</a><a class="a-color" style="margin-left: 385px;font-size: 15px">适用于:</a><br>
                <a  style="font-size: 13px;color: #8E8B8B">自由</a><a style="color: #8E8B8B;margin-left: 400px;font-size: 13px">1{{items.shopid.shopdanwei}}</a><br><br>
